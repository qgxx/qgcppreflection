#ifndef __VARIABLE_TRAITS_H__
#define __VARIABLE_TRAITS_H__
...
template <typename T> struct variable_traits<T*> : internal::basic_variable_traits<T> {
...
struct variable_traits<T Class::*> : internal::basic_variable_traits<T Class::*> {
    ...
    using class_value = Class;
};

#endif // !__VARIABLE_TRAITS_H__